...
public abstract class GameObject extends JGObject {
	...
	public boolean checkTrigger(GameEngine myEngine) {
		...
		ResourceBundle behaviors = ResourceBundle
				.getBundle(SaladConstants.DEFAULT_ENGINE_RESOURCE_PACKAGE
						+ SaladConstants.OBJECT_BEHAVIOR);
		Object answer = SaladUtil.behaviorReflection(behaviors, myTrigger,
				myTriggerParameter, "checkTrigger", myEngine);
	...
	/**
	 * Below four methods overriding the interface Subject in the observer
	 * pattern
	 */
	@Override
	...
	/*
	 * @Steve: The following getter and setters used for GameFactoryTest Will
	 * remove them once finished
	 */
	/**
