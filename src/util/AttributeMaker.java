...
public class AttributeMaker {
     ...
     */
    public static String addAttribute (String key,
                                       String type,
                                       boolean duplicated,
                                       List<Object> params) {
        ...
        if (duplicated) {
            attribute.append(SaladConstants.SEPARATOR + type);
        }
        for (Object o : params) {
    ...
    public static String addAttribute (String key,
                                       ...
                                       List<Object> params) {
        StringBuilder attribute = new StringBuilder();
        attribute.append(key + SaladConstants.SEPARATOR + firstType + SaladConstants.SEPARATOR +
                         firstParameter + SaladConstants.SEPARATOR + secondType);
        if (duplicated) {
            attribute.append(SaladConstants.SEPARATOR + secondType);
        }
        for (Object o : params) {
            attribute.append(SaladConstants.SEPARATOR + o.toString());
        }
    ...
    public static String addAttribute (String key, String type, int parameter) {
        StringBuilder attribute = new StringBuilder();
        attribute.append(key + SaladConstants.SEPARATOR + type + SaladConstants.SEPARATOR +
                         parameter);
        return attribute.toString();
    }
     ...
     * @return String attribute
     */
    public static String addAttribute (String modifyTriggerEventManager,
                                       String collisionId,
                                       Object object,
                                       String setTrigger,
                                       Object object2,
