...
public class Game {
    ...
    /**
     * Called to get Game Objects (including Player) that matched with a certain collision ID from
     * the whole game
     * 
    ...
    public List<GameObject> getObjectsByColid (int colid) {
        ...
        if (getPlayer(NONUSE_ID) != null && getPlayer(NONUSE_ID).colid == colid)
            objects.add(getPlayer(NONUSE_ID));
        return objects;
    }
    ...
    public List<String> getAttributes () {
        ...
        for (Entry<Character, String> entry : getTileImageMap()) {
            ...
            answer.add(AttributeMaker.addAttribute(SaladConstants.SET_DRAG_TILE,
                                                   SaladConstants.COLLISION_ID, cid,
